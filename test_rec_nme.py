...
# general
parser.add_argument('--rec', default='/media/3T_disk/my_datasets/data_2d/cofw_testset.rec', help='rec data path')
parser.add_argument('--prefix', default='./model/sdu', help='model prefix')
